...
/**
 * @module ui/dropdown/menu/menubarview
 */
...
import { DropdownMenuListItemFileDialogButtonView } from './dropdownmenulistitemfiledialogbuttonview.js';
import {
	MenuBarBehaviors,
 ...
 */
export default class DropdownView extends View implements FocusableView {
	/**
	 * Collection of the child views inside the {@link #element}.
	 */
	public children: ViewCollection<DropdownMenuView>;
	...
	/**
	 * A list of {@link module:ui/menubar/DropdownMenuview~DropdownMenuView} instances registered in the menu bar.
	 *
	 * @observable
	 */
	...
	/**
	 * Registers a menu view in the menu bar. Every {@link module:ui/menubar/DropdownMenuview~DropdownMenuView} instance must be registered
	...
	/**
	 * Creates a {@link module:ui/menubar/DropdownMenuview~DropdownMenuView} based on the given definition.
	 */
	...
	/**
	 * Creates a {@link module:ui/menubar/DropdownMenuview~DropdownMenuView} items based on the given definition.
	 */
	...
	private _createMenuItemContentFromFactory( { componentName, parentMenuView, componentFactory }: {
		...
		if ( !(
			...
			componentView instanceof DropdownMenuListItemFileDialogButtonView
		) ) {
			/**
			 * Adding unsupported components to the {@link module:ui/menubar/menubarview~MenuBarView} is not possible.
			 *
			 * A component should be either a {@link module:ui/menubar/DropdownMenuview~DropdownMenuView} (sub-menu) or a
			 * {@link module:ui/menubar/DropdownMenulistitembuttonview~DropdownMenuListItemButtonView} (button).
			 *
	 ...
	 * for each item that is {@link module:ui/menubar/DropdownMenuview~DropdownMenuView}.
	 *
	 * @internal
	 */
...
export type MenuBarConfigAddedGroup = {
	group: DropdownMenuGroupDefinition;
	position: MenuBarConfigAddedPosition;
};

export type MenuBarConfigAddedMenu = {
	menu: DropdownMenuDefinition;
	position: MenuBarConfigAddedPosition;
};
